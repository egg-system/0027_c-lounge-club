...
class SwpmMiscUtils {
    ...
    public static function get_login_link() {
        ...
        $login_msg = '';
// 「お願い」を削除
// backup　→ $login_msg .= SwpmUtils::_('Please') . ' <a class="swpm-login-link" href="' . $filtered_login_url . '">' . SwpmUtils::_('Login') . '</a>. ';
        $login_msg .= SwpmUtils::_(' ') . ' <a class="swpm-login-link" href="' . $filtered_login_url . '">' . SwpmUtils::_('Login') . '</a>. ';

        // 「あなたは会員ですか？会員について」を削除
