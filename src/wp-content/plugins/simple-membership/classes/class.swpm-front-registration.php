...
class SwpmFrontRegistration extends SwpmRegistration {
    ...
    public function regigstration_ui($level) {
        ...
        if (empty($membership_level)) {
            ...
            $free_rego_disabled_msg .= SwpmUtils::_('あああああああ　Free membership is disabled on this site. Please make a payment from the ' . $joinuspage_link . ' page to pay for a premium membership.');
